  ...
  return (
    <section id="home" className="container mx-auto px-4 py-12 sm:py-24 relative z-10">
      ...
      <div className="max-w-6xl mx-auto relative">
        <div className="fluid-glass floating-glass reveal-glass relative bg-paper-gray border-4 border-ink-black p-4 sm:p-12 shadow-cutout transform -rotate-1 mb-20 clip-torn">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start relative">
            <div className="fluid-glass reveal-glass w-full md:w-2/3 bg-white p-6 border-2 border-ink-black shadow-[4px_4px_0px_0px_rgba(0,0,0,0.2)] transform rotate-1">
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                <button onClick={() => scrollToId("projects")} className="cursor-target px-6 py-3 bg-sharpie-blue text-white font-mono font-bold text-lg hover:bg-ink-black transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] border-2 border-ink-black">
                  VIEW_PROJECTS
                </button>
                <button onClick={() => scrollToId("contact")} className="cursor-target px-6 py-3 bg-white text-ink-black font-mono font-bold text-lg hover:bg-ink-black hover:text-white transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] border-2 border-ink-black">
                  CONTACT_ME
                </button>
                <a href="https://github.com/sarthakroutray" target="_blank" rel="noreferrer" className="cursor-target px-6 py-3 bg-ink-black text-white font-mono font-bold text-lg hover:bg-sharpie-blue transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] border-2 border-ink-black">
                  VIEW_GITHUB
                </a>
                <a href="/Sarthak%20Routray%20CV.pdf" download="Sarthak_Routray_CV.pdf" className="cursor-target px-6 py-3 bg-paper-gray text-ink-black font-mono font-bold text-lg hover:bg-ink-black hover:text-white transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] border-2 border-ink-black">
                  DOWNLOAD_RESUME
                </a>
              </div>
            </div>
            ...
            <div className="w-full md:w-1/3 relative mt-8 md:mt-0">
              ...
              <div className="fluid-glass reveal-glass border-2 border-ink-black bg-neutral-200 p-4 transform -rotate-2 shadow-cutout">
                <h4 className="font-ransom text-3xl mb-4 text-center border-b-2 border-black pb-2">TOOLKIT</h4>
